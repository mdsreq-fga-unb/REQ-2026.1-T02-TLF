...
export declare class RecurrenceService {
    ...
    remove(userId: string, id: string, dto?: DeleteRecurrenceDto): Promise<RecurrenceDetailResponseDto>;
    generateTransactionsFromRecurrences(): Promise<void>;
    private validateAccountOwnership;
    private validateCategoryOwnership;
    private validateSubCategory;
    private validateDates;
    private getRecurrenceOrThrow;
}
