...
5. Quando o item envolve interface com o usuário, existe ao menos um protótipo ou esboço aprovado pelo cliente Rodrigo Átila, disponível como referência no repositório ou na Work Item List no Trello.
