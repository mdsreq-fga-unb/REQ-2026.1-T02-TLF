...
| CP11 | Comunicação e Feedback ao Usuário       | O sistema deve apresentar mensagens de erro padronizadas, claras e legíveis, além de disponibilizar um meio para o usuário enviar feedback sobre sua experiência ou identificar problemas no aplicativo. | Reforça a usabilidade e a comuniçãos ao usuário. OE6                       | -                      |
