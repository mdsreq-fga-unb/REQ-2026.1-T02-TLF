...
| CP8  | Organização da análise financeira    | Permite filtrar gastos por data, instituição, conta, categoria, tipo e valor.    | Apoia uma análise mais precisa dos dados financeiros.        | OE4                    | OE2                     |
